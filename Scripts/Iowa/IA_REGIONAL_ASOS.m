...
% ASOS Observations – Single Station Analysis Iowa
...
asosFile  = "4187018.csv";        % ASOS CSV
stationID = 72542014931;          % NUMERIC station ID (e.g., KMAF)
...
outDir = fullfile(pwd,'Working','Results','ASOS-Regional-IA');
